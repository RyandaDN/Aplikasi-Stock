...
require 'function.php';
    ...
    //(Login S1) Jika sudah login (sudah masuk ke dashboard) dan ingin kembali ke menu login maka akan dikembalikan ke dashboard
...
<html lang="en">
    <head>
        ...
        <title>Login - Stock.U Aplikasi Stock Barang</title>
